...
function detectOS(): OS {
  ...
  const platform = (window.navigator as Navigator & { userAgentData?: { platform: string } }).userAgentData?.platform?.toLowerCase() ||
...
const FEATURES = [
  {
    ...
    description: 'Instantly convert speech to text with industry-leading accuracy. Support for 30+ languages with automatic detection.',
  },
  {
    icon: UsersIcon,
    title: 'Speaker Diarization',
    description: 'Automatically identify and label different speakers in your recordings. Perfect for meetings, interviews, and podcasts.',
  },
  {
    icon: UserPenIcon,
    title: 'Custom Speaker Names',
    description: 'Rename speakers from "Speaker 1" to real names like "John" or "Sarah". Names persist across all exports and views.',
  },
  {
    icon: SparklesIcon,
    title: 'AI Actions',
    description: 'One-click AI actions: generate summaries, extract tasks, uncover key insights, translate, or clean up formatting.',
  },
  {
    icon: GlobeIcon,
    title: 'Multi-Language Translation',
    description: 'Translate your transcripts to 15+ languages instantly using AI. Break down language barriers effortlessly.',
  },
  {
    icon: ShareIcon,
    title: 'Flexible Export Options',
    description: 'Export to PDF, Markdown, or email. Send to Notion with one click. Connect webhooks for Zapier, n8n, or Make.',
  },
  {
    icon: WebhookIcon,
    title: 'Automation Ready',
    description: 'Connect to your favorite tools via webhooks. Automatically send transcripts to Zapier, n8n, Make, or any custom endpoint.',
  },
  {
    icon: ShieldIcon,
    title: 'Privacy-First Design',
    description: 'Your data stays on your device with encrypted local storage. Optional local LLM support via Ollama.',
  },
  {
    icon: ZapIcon,
    title: 'Global Hotkey',
    description: 'Start recording instantly from anywhere with a customizable global keyboard shortcut. Never miss a moment.',
  },
];
  ...
  return (
    <div className="min-h-screen bg-background">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-sm text-muted-foreground">
              <div className="flex items-center gap-2">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-primary/40 to-primary/20 border-2 border-background" />
                  ))}
                </div>
            ...
            <div className="relative mx-auto max-w-5xl">
              <div className="rounded-xl border bg-card shadow-2xl overflow-hidden">
                ...
                <div className="aspect-[16/10] bg-gradient-to-br from-card to-muted/30 p-8">
                  <div className="h-full rounded-lg border bg-background/50 flex items-center justify-center">
                    <div className="text-center">
                      ...
                      <p className="text-sm text-muted-foreground">Press ⌘+Shift+R to start recording</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {STEPS.map((step, index) => (
              <div key={step.number} className="relative">
                {index < STEPS.length - 1 && (
                  <div className="hidden lg:block absolute top-12 left-full w-full h-px bg-gradient-to-r from-primary/50 to-transparent -translate-x-1/2" />
                )}
                <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            ...
            <div className="p-6 rounded-2xl bg-card border hover:border-primary/50 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-sm text-muted-foreground">One-click OAuth connection. Export directly to your workspace pages.</p>
            </div>

            {/* Zapier Integration */}
            <div className="p-6 rounded-2xl bg-card border hover:border-primary/50 hover:shadow-lg transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[#FF4A00] flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-muted-foreground">Connect via webhooks to 5,000+ apps. Automate your transcript workflow.</p>
            </div>

            {/* n8n Integration */}
            <div className="p-6 rounded-2xl bg-card border hover:border-primary/50 hover:shadow-lg transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[#EA4B71] flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/>
                </svg>
              </div>
              <h3 className="text-lg font-semibold mb-2">n8n</h3>
              <p className="text-sm text-muted-foreground">Self-hosted automation. Full control over your data and workflows.</p>
            </div>

            {/* PDF Export */}
            <div className="p-6 rounded-2xl bg-card border hover:border-primary/50 hover:shadow-lg transition-all duration-300">
              <div className="w-12 h-12 rounded-xl bg-[#E44332] flex items-center justify-center mb-4">
                <FileTextIcon className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-lg font-semibold mb-2">PDF Export</h3>
              <p className="text-sm text-muted-foreground">Beautiful formatted documents with speaker labels and timestamps.</p>
            </div>
          </div>
      ...
      <section id="download" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative rounded-3xl bg-gradient-to-br from-primary/10 via-primary/5 to-transparent border p-12 lg:p-16 overflow-hidden">
            ...
            <div className="relative grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="mb-8">
                  <Button size="lg" className="h-16 px-8 text-lg gap-3" asChild>
                    <a href={primaryDownload.url}>
                      <primaryDownload.icon className="w-6 h-6" />
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {Object.entries(DOWNLOAD_LINKS).map(([os, info]) => {
                      if (os === detectedOS || (detectedOS === 'unknown' && os === 'mac')) return null;
                      return (
              ...
              <div className="lg:pl-12">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <AppleIcon className="w-5 h-5 text-muted-foreground shrink-0 mt-0.5" />
                    <div>
                      <div className="font-medium">macOS</div>
                      <div className="text-sm text-muted-foreground">macOS 12 (Monterey) or later, Apple Silicon or Intel</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <WindowsIcon className="w-5 h-5 text-muted-foreground shrink-0 mt-0.5" />
                    <div>
                      <div className="font-medium">Windows</div>
                      <div className="text-sm text-muted-foreground">Windows 10 (1803+) or Windows 11, 64-bit</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <LinuxIcon className="w-5 h-5 text-muted-foreground shrink-0 mt-0.5" />
                    <div>
                      <div className="font-medium">Linux</div>
                      <div className="text-sm text-muted-foreground">Ubuntu 20.04+, Fedora 36+, or equivalent</div>
                    </div>
                  </div>
                </div>
